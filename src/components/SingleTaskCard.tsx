    ...
    <Card className="flex flex-col h-full justify-between mb-5 cursor-grab">
      <div>
        <div className="flex items-center justify-between">
          <h2 className="font-proxima-nova-semibold text-lg cursor-pointer underline text-primary-500 underline-offset-2 transition-all hover:scale-95">{title}</h2>
      ...
      <Progress percent={progress} strokeColor="#287292" showInfo={false} />
    </Card>
  );
};
